...
#    Updated: 2025/02/23 16:19:17 by rraumain         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
EXPAND_SRC = $(addprefix expander/, expander.c vars.c)
...
SRC = $(addprefix src/, main.c $(LEXER_SRC) $(EXPAND_SRC) $(PARSER_SRC) $(EXEC_SRC) $(UTILS_SRC))
