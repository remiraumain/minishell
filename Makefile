...
#    Updated: 2025/03/12 12:28:16 by nolecler         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BUILTIN_SRC = $(addprefix builtins/, builtin_control.c echo.c cd.c pwd.c env.c exit.c unset.c env_list_copy.c env_copy.c utils1.c) 
