...
#    Updated: 2025/03/31 17:51:34 by nolecler         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BUILTIN_SRC = $(addprefix builtins/, builtin_control.c echo.c utils_cd.c cd.c pwd.c env.c exit.c unset.c export.c utils_export.c utils_exit.c) 
