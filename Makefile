...
#    Updated: 2025/04/22 14:06:19 by nolecler         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LEXER_SRC = $(addprefix lexer/, lexer.c token.c parse.c utils.c utils2.c expander.c vars.c quotes.c)
...
SRC = $(addprefix src/, main.c init.c underscore.c $(LEXER_SRC) $(PARSER_SRC) $(EXEC_SRC) $(BUILTIN_SRC) $(SIGNALS_SRC) $(UTILS_SRC))
