...
/*   Updated: 2025/03/22 13:32:35 by nolecler         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 4- export expand a gerer $titi=toto+tata


static void ft_sort_params(t_envp *env)
{
    t_envp *i;                // Ptr pour parcourir la liste
    t_envp *j;                // Ptr pour comparer les éléments
    char *tmp_name;          // Var temp pour échanger les noms
    char *tmp_value;         // Var temp pour échanger les valeurs
