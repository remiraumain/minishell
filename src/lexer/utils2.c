...
/*   Updated: 2025/04/11 11:09:04 by nolecler         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char *extract_expanded_substring(const char *input, int start, int end, t_global_data *data)
{
    char *substring;
...
static char *extract_and_finalize_chunk(const char *input, int len, char **word, t_global_data *data)
{
    char *chunk;
    char *substring;
        ...
        char *word)
{
    ...
    chunk = extract_and_finalize_chunk(input + start, *index - start, &word, data);
    return (chunk);
}
